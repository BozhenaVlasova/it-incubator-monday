...
//Hi guys!
// TODO 1. Let's create a 'DELETE ALL TASKS' button, and place it above the filter buttons
//Clicking the button removes all tasks
// TODO 2. Let's create a fourth filter button-if you click it, the first three tasks will be displayed
